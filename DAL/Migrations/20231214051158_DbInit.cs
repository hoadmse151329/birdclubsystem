    ...
    public partial class DbInit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ClubInfo__DF4AEAB2B80BD850", x => x.clubId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ContestS__B56A0C8DD44B44C9", x => x.scoreId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ContestM__769A271A7CF0320F", x => x.pictureId);
                    table.ForeignKey(
                        name: "FK_Contest",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Fieldtri__769A271A7C84EFD2", x => x.pictureId);
                    table.ForeignKey(
                        name: "FK_FieldTrip",
                        column: x => x.tripId,
                        principalTable: "FieldTrip",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__MeetingM__769A271A8E424EAF", x => x.pictureId);
                    table.ForeignKey(
                        name: "FK_Meeting",
