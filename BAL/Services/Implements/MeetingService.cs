...
namespace BAL.Services.Implements
{
    public class MeetingService : IMeetingService
    {
        ...
        public void Update(MeetingViewModel entity)
        {
            ...
            var media = _unitOfWork.MeetingMediaRepository.GetMeetingMediasByMeetingId(entity.MeetingId.Value).Result;
            ...
            if (media == null)
            {
                ...
                _unitOfWork.Save();
                media = _unitOfWork.MeetingMediaRepository.GetMeetingMediasByMeetingId(entity.MeetingId.Value).Result;
            }
        ...
        public async Task<bool> UpdateStatus(UpdateMeetingStatusVM entity)
        {
            ...
            var meetinglist = await _unitOfWork.MeetingParticipantRepository.GetCountMeetingParticipantsByMeetId(entity.MeetingId.Value);
            if(entity.Status.Equals("CheckingIn") && meetinglist < 10)
            {
                return false;
            }
            meeting.NumberOfParticipants = meetinglist;
